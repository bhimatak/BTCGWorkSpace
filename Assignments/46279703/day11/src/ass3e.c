 ...
 * * FILE NAME :  ass3e.c
 * *
 * * DESCRIPTION : The file defines to read a line of text max length 80 from user,extract words and store dynamically
 * * 
 * * REVISION HISTORY :
 ...
 * *
 * * copyrights@2022 ,Aricient Technologies(Holidings) Ltd
 * *******************************************************************************************************************/ 
