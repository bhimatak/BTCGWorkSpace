 ...
 * * FILE NAME  :ass5.c
 * *
 * * DESCRIPITION  : Read atleast three or more command lines
 * *
 * * REVISION HISTORY :
...
#include<ctype.h>
/******************************************************************************************************
 * * FUNCTION NAME :  srvername and port number
 * *
 * * DESCRIPTION   :  Read atleast three or more command lines
 * *
...
int main(int argc, char* argv[])
{
	...
	{
		printf("enter atleast  three arguments\n");
	}
	return EXIT_SUCCESS;
}
