 ...
 * FILE NAME : day11.c
 *
 * DESCRIPTION : The file defines to read a line of text max length 80 from user, to extract words and store them in double dynamically and perform operations
 *
 * REVISION HISTORY :
 *
 * DATE                    NAME                         REFERENCE                              REASON
 * --------------------------------------------------------------------------------------------------------
 *  06 OCT 2022         Charishma                        CAPG123                            new code
 *
 *  ********************************************************************************************************/
