/***********************************************************************************************
 * * FILENAME :12.c
 * * *DESCRIPTION: This file finds out the storing elements,printing the stored elements,sum of min&max of elements,counting the occurences of elements,reversing the elements.
 * * *REVISION HISTORY:
 * *
