/**************************************************************************************************************************
 ** *FILENAME :13.c
 ** *DESCRIPTION: This file gives the server name and port number and concatenating the server names.
 ** *REVISION HISTORY:
 **
 **         NAME               REFERENCE                           REASON
 ** ---------------------------------------------------------------------------------------------------------------------
 *     NADIGATLA PARIMALA        NEW                             NEW CODE TO PRINT SERVER NAMES AND PORT NUMBERS 
 **  *********************************************************************************************************************/
