 ...
 * * FILENAME   : assign.c
 * *
 * * DESCRIPTION : This file defines the allocated memory and concatenated server names.
 * *
 * * Return      : This function returns the concatenated server names.
 * *
 * ************************************************************************************/
#include<stdio.h>
#include<stdlib.h>
...
int main(int argc, char* argv[])
{
	...
	{
		printf("Enter atleast 3 arguments\n");
	}
	return EXIT_SUCCESS;
}
