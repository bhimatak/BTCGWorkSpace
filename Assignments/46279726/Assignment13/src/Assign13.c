/**************************************************************************************************
 *
 *  FILE NAME     : Assign13.c
 *
 *  DESCRIPTION   : Functions to receive a word, to extract and display the server name and port number
 *
 *  DATE                          NAME                          REFERENCE                               REASON
 *  05 NOV 2022              GOWRILATHA CHOPPA                  CG MATERIAL                      commmand line arguments 
 *
 *  Copyright 2010, Capgemini Aricient Technologies (Holding) Ltd
 *
 *  ****************************************************************************************************************************/
