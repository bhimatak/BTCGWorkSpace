/**********************************************************
* *FILE NAME   :Assign18-19.c
* *
* * DESCRIPTION : program to demonstrate linked list operstions on words from a file
* *
* *Revision History:
* * DATE 		       0NAME   		   REFERNCE 		      REASON
* * 
* *20-11-2022    GOWRILATHA CHOPPA        new               Employee referal
* *
 ...
 struct node{
  ...
  struct node *read(FILE *fp){
   ...
   void search_delete(char word[10]){
	 ...
	 printf("Number of time word '%s' is %d",word,c);
   }
   void search_delete(char word[10]){
     struct node *p,*t;
	 t=start;
