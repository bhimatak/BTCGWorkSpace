 ...
 * *
 * * DESCRIPTION : This file accept the array elements from user, It returns the 
 * *		    sum of the maximum and minimum element of the array
 * *
 * * REVISION HISTORY :
 * *
 * * DATE 	        NAME	  REFERENCE 	  REASON
 * *----------------------------------------------------------------------------
 * * 6 October2022   Ramadevi       agas	The assignment of CG
 * *
 * *****************************************************************************/
 ...
 * *
 * * DESCRIPTION : it displays the array values 
 * *
 * * RETURNS : RETURNS EXIT_SUCCESSFUL in case of successful execution
 * *	       RETURNS EXIT_FAILURE in case of limit of array exceeded
 * *
 * ********************************************************************************/
  int arr[MAX_SIZE] = {0};
int totalElements = 0;
