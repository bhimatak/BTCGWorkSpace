...
**
** DESCRIPTION     : This file defines to read a line of text of max length 80 from user, to extract the words, store them in 
                     double pointer dynamically allocating memoery and perform the certain operations. 
**
** REVISION HISTORY:
** DATE              NAME                 REFERENCE                                            REASON
----------------------------------------------------------------------------------------------------------------------------------------------
** 05 OCT 2022     POOJA NATH               NEW                                        NEW CODE TO PERFORM FUNCTION
**
************************************************************************************************************************************************/
