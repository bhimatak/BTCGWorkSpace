 ...
 * * FILE NAME: Day12.c
 * *
 * * DESCRIPTION: This file contains display of elements, reverse, count 
 * * and return the sum of maximum and minimum.
 * *  
 * * DATE           NAME            REFERENCE         REASON
 * * ----------------------------------------------------------------------
 * * 6 OCT 2022     RASHMI KUMARI   CAPG12345         FIXED SIZE ARRAY 
 * *
 * *
...
/*************************************************************************
 * * FUNCTION NAME: arrayDisplay
 * * DESCRIPTION: The function display the array element, reverse, 
 * * count and return.
 * * 
 * ************************************************************************/
...

{
	...
	scanf("%d", &size);
	printf("Enter the number of elements to enterin array:");
	scanf("%d", &num);
