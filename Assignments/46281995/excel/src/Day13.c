 ...
 * * FILE NAME: Day13.c
 * *
 * * DESCRIPTION: This file read atleast 3 or more command line arguments and 
 * * display port number with server names
 * * 
 * * DATE           NAME           REFERENCE        REASON
 * * ------------------------------------------------------------------------------
 * * 6 OCT 2022     RASHMI         CAPG12345        CONCATENATE ALL SERVER NAME
 * * 
 * *
 ...
 * * DESCRIPTION: This function concatenate all server names.
 * *
 * ********************************************************************************/
