...
int cmd_validate(char* word) //function declaration
{
	char *temp_var = NULL;/* variable declaration*/
	char *token=NULL;
	int portNo;
	int i=0;
	int allAlphabets=1; /*variable declaration*/
...
char* extract_servername(char* word) //function declaration
{
	char* temp = NULL; //variable declaration
	char* token = NULL;
	int portNo;
...
char* concatenate_servernames(char* server_name[], int count) //function declaration
{
	char* result = NULL;
